...
const events = [
  // --- TECHNICAL EVENTS ---
  {
    ...
    category: 'technical',
    order: 1,
    description: 'We are excited to invite students to participate in the Paper Presentation event at our college. This is a great opportunity to present innovative ideas, research, technical knowledge, and creative solutions in your field of interest.',
    fullDescription: 'Participants are requested to submit their paper before the deadline. Selected participants will get the opportunity to present their papers in the event.',
    rules: [
      'Submit your paper before the deadline: 04/09/2026.',
      'Submission email: suyamburaj@gmail.com',
  ...
  },
  {
    ...
    category: 'technical',
    order: 2,
    description: 'Participants must develop a complete website using AI tools and successfully deploy it online. The challenge tests how effectively participants can use AI to transform their ideas into a creative, functional, and user-friendly website.',
    fullDescription: 'In this event, participants must develop a complete website using AI tools and successfully deploy it online. The challenge tests how effectively participants can use AI to transform their ideas into a creative, functional, and user-friendly website.',
    rules: [
    ...
    evaluationCriteria: [
      { title: 'Creativity', description: 'Innovation, uniqueness, and design of the website.' },
      { title: 'Communication', description: 'Ability to clearly explain the idea, development process, and features.' },
      { title: 'Functionality', description: 'All features should work properly without major errors.' },
      { title: 'Deployment', description: 'The website must be successfully deployed and accessible online.' }
    ],
  ...
  },
  {
    ...
    category: 'technical',
    order: 3,
    description: 'Bug Buster is a two-round technical competition designed to test participants\' technical knowledge, problem-solving ability, and debugging skills.',
    fullDescription: 'Bug Buster is a two-round technical competition designed to test participants\' technical knowledge, problem-solving ability, and debugging skills. The Top 3 participants/teams will be selected as winners based on overall performance.',
    rounds: [
      {
        roundNumber: 1,
        title: 'Technical Quiz',
        description: 'Participants will answer technical questions in a buzzer-based quiz.',
        rules: [
      ...
      },
      {
        ...
        description: 'Participants must identify and correct errors in programming code.',
        rules: [
  ...
  // --- NON-TECHNICAL EVENTS ---
  {
    ...
    order: 4,
    description: 'Treasure Hunt 2.0 is an exciting QR Code-based adventure event that tests participants\' problem-solving, observation, and clue-solving skills.',
    fullDescription: 'Each participant/team starts by scanning the first QR code. After scanning, they receive a question, puzzle, or challenge. Participants must solve the puzzle correctly to unlock the clue for the next QR code location. The team/participant that successfully completes all stages in the shortest time will be declared the winner.',
    rounds: [
      {
        roundNumber: 1,
  ...
  },
  {
    ...
    category: 'non-technical',
    order: 5,
    description: 'Connect & Sketch is a creative team event that combines visual thinking, observation, communication, drawing and technical-word recognition.',
    fullDescription: 'Connect & Sketch is a creative team event with two rounds. In Round 1 (Bioscope), teams observe a series of images, connect them logically, and identify the common concept/word. Qualifiers proceed to Round 2 (Draw & Guess), where one team member draws a technical concept while teammates guess the word.',
    rounds: [
      {
        roundNumber: 1,
        title: 'Bioscope — Connect the Images',
        description: 'Participants will be shown a series of images. They must observe, connect the images logically, and identify the correct word or concept.',
        rules: [
      ...
      },
      {
        roundNumber: 2,
        title: 'Draw & Guess',
        description: 'One person from the team will be given a word. That participant must draw the concept without speaking the word, while teammates must identify what is being drawn.',
        rules: [
  ...
  },
  {
    ...
    order: 7,
    description: 'A new non-technical challenge is coming soon! Stay tuned for the next exciting event announcement.',
    fullDescription: 'Stay tuned for the next exciting event announcement. This event will be revealed soon.',
    tagline: 'Stay tuned for the next exciting event announcement.',
    isTeamEvent: false,
    maxTeamSize: 1,
    minTeamSize: 1,
...
const defaultSettings = [
  ...
  { key: 'contactEmail', value: 'info@vvcoe.edu.in', label: 'Contact Email' },
  ...
  { key: 'registrationOpen', value: true, label: 'Global Registration Open/Close' },
];
...
const seed = async () => {
  ...
  const admin = new Admin({
    ...
    passwordHash: 'techfest2026', // will be hashed by pre-save hook
    role: 'superadmin'
  });
  await admin.save();
  console.log('✅ Admin created: username=admin, password=techfest2026');
