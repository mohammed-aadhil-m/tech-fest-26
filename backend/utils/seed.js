...
const defaultSettings = [
  ...
  { key: 'contactEmail', value: 'techfest.official2026@gmail.com', label: 'Contact Email' },
...
const seed = async () => {
  ...
  await Admin.findOneAndUpdate(
    { username: 'admin' },
    {
      ...
      passwordHash: '$2a$10$f9n8g4P5mR9b0l1s8s7Zq.gX4vX9vQ5q6yG4s9l2vP0xZ1y3l5v5q', // hashed or hook
      role: 'superadmin'
    },
