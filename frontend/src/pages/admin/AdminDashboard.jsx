...
export default function AdminDashboard() {
  ...
  const statCards = [
    ...
    { icon: <CalendarDays size={22} />, label: 'Total Teams', value: stats?.totalTeams, color: 'text-red-500', link: '/admin/teams' },
  ...
  return (
    <div className="p-6 md:p-8 relative z-10">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-display font-black text-white tracking-wide">Dashboard <span className="text-red-500">Overview</span></h1>
        <p className="text-gray-400 text-sm mt-1 uppercase tracking-wider font-bold">Event statistics and live registrations</p>
      </div>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid lg:grid-cols-2 gap-6 mb-8">
            ...
            >
              <h2 className="text-sm font-display font-bold text-white mb-6 uppercase tracking-widest border-b border-white/10 pb-4">Registrations by Event</h2>
            ...
            >
              <div className="flex items-center justify-between mb-6 border-b border-white/10 pb-4">
                <h2 className="text-sm font-display font-bold text-white uppercase tracking-widest">Recent Registrations</h2>
              ...
              {stats?.recent && stats.recent.length > 0 ? (
                ...
                <div className="text-center py-10 border border-dashed border-white/10 rounded-xl bg-white/5">
                  <p className="text-gray-500 text-xs font-bold uppercase tracking-widest">No recent registrations</p>
                </div>
              )}
            </motion.div>
          </div>
          ...
          <motion.div
            ...
            className="bg-black/60 border border-white/10 rounded-2xl p-6 backdrop-blur-md shadow-[0_0_15px_rgba(0,0,0,0.5)]"
          >
            <h2 className="text-sm font-display font-bold text-white mb-6 uppercase tracking-widest border-b border-white/10 pb-4">Quick Actions</h2>
